  ...
  return (
    <>
      ...
      <main className="__root spacesummit">
        {toBeAnnouncedSoon ? (
          <div className="pt-5">
            <h6 className="soon">Event Details will be announced soon</h6>
            <div className="row justify-content-center gap-3 mt-4 ">
              <Button
                type="link"
                color="primary"
                href={`${eventFacebookLink}`}
                name={"Event Day Registration"}
              ...
              <Button
                type="link"
                color="primary"
                href={`/spacesummit/editions/${editionNum}/eventday`}
                name={"Event Day Registration"}
                className="col-12 col-sm-6 col-lg-4 mt-2"
              >
                Event Registration
              ...
              <Button
                type="link"
                color="primary"
                href={`/spacesummit/editions/${editionNum}/competition`}
